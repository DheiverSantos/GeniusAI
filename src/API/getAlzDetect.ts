...
const LINK_API =
  'https://api-inference.huggingface.co/models/DHEIVER/Alzheimer-MRI'

async function getAlzDetect(imageBlob: Blob): Promise<ApiResponse> {
  if (!imageBlob) {
